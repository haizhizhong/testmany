...
namespace AlertProperties.LandDevelopment
{
    ...
    public partial class ucBuilderNextLotDrawExclusion : ucPropertyInterface
    {
        private ucCommPurDocMerge CommPurDocMerge;
        public ucBuilderNextLotDrawExclusion()
        {
            InitializeComponent();
        }

        private void ucBuilderNextLotDrawExclusion_Load(object sender, EventArgs e)
        {
            LoadUserControls();
