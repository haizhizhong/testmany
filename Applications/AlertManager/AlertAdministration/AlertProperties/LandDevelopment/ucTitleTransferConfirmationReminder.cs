...
{
    public partial class ucTitleTransferConfirmationReminder : ucPropertyInterface
    {
        private ucCommPurDocMerge CommPurDocMerge;

        public ucTitleTransferConfirmationReminder()
        {
            InitializeComponent();
        }
        ...
        private void ucTitleTransferConfirmationReminder_Load(object sender, EventArgs e)
        {
            LoadUserControls();
