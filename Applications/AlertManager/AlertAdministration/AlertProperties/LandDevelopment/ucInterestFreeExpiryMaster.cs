...
{
    public partial class ucInterestFreeExpiryMaster : ucPropertyInterface
    {
        private ucCommPurDocMerge CommPurDocMerge;

        public ucInterestFreeExpiryMaster()
        {
            InitializeComponent();
        }
        ...
        private void LoadUserControls()
        {
            ...
            CommPurDocMerge.DocMergeFunction_ID = 4; // MASTER AGREEMENT MERGE
            CommPurDocMerge.Dock = DockStyle.Fill;
            CommPurDocMerge.Parent = pGrid;
            CommPurDocMerge.tpTolerance.PageVisible = false;
        }

        private void ucInterestFreeExpiryMaster_Load(object sender, EventArgs e)
        {
            LoadUserControls();
